    ...
    <div style={{ minHeight: '100vh', padding: 40 }}>
      <div className="card analytics-card" style={{ maxWidth: 900, margin: '0 auto', borderRadius: 20, padding: 36 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
          <h2 className="page-title" style={{ fontWeight: 'bold', fontSize: 28 }}>Grades & Performance Analytics</h2>
          <div>
            <button style={{ background: '#f3eaff', color: '#6a11cb', border: 'none', borderRadius: 8, padding: '7px 18px', fontWeight: 'bold', cursor: 'pointer', marginRight: 12 }}>Export Report</button>
            <button style={{ background: '#e3fcec', color: '#2575fc', border: 'none', borderRadius: 8, padding: '7px 18px', fontWeight: 'bold', cursor: 'pointer' }}>Filter</button>
          </div>
        </div>
        <div style={{ color: 'var(--analytics-desc-color, #888)', fontSize: 17, marginBottom: 24 }}>Track your academic progress and identify areas for improvement</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
          <div style={{ background: 'rgba(255,255,255,0.08)', borderRadius: 16, padding: 24, minHeight: 220, color: '#b3b8d1', boxShadow: '0 2px 8px #23244a22' }}>
            <div style={{ color: '#b3b8d1', fontWeight: 'bold', fontSize: 18, marginBottom: 8 }}>Grade Trends</div>
            ...
            <div style={{ color: '#b3b8d1', fontSize: 13, marginTop: 8 }}>Weekly, Monthly, Semester</div>
          </div>
          <div style={{ background: 'rgba(255,255,255,0.08)', borderRadius: 16, padding: 24, minHeight: 220, color: '#b3b8d1', boxShadow: '0 2px 8px #23244a22' }}>
            <div style={{ color: '#b3b8d1', fontWeight: 'bold', fontSize: 18, marginBottom: 8 }}>Missed Tasks</div>
            <svg width="100%" height="80" viewBox="0 0 200 80">
            ...
            <div style={{ color: '#b3b8d1', fontSize: 13, marginTop: 8 }}>By Subject, By Week, By Type</div>
          </div>
        </div>
      </div>
    </div>
